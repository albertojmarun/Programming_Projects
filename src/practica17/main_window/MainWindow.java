 ...
 */
package practica17.main_window;
...
public class MainWindow extends javax.swing.JFrame {
    ...
    private final String HORROR_GENRE_ES = "Horror";
    private final String COMEDY_GENRE_ES = "Comedia";
    private final String ROMANCE_GENRE_ES = "Romance";
    private final String CHILD_AGE_ES = "Infantil";
    private final String SEVEN_AGE_ES = "Mayores de 7 Años";
    private final String TWELVE_AGE_ES = "Mayores de 12 Años";
    private final String ADULT_AGE_ES = "Adulto";
