...
public final class MainWindow extends javax.swing.JFrame {
    ...
    /**
     * Introduce all the selected values from the user.
     */
    private Book assignBookInformation(){
        Book book = new Book();
        
        book.setTitle(bookTitleInput.getText());
        book.setAuthor(bookAuthorInput.getText());

        if(editorialOptions.getSelectedIndex() != 0){
            book.setEditorial(editorialOptions.getSelectedItem().toString());
        }
    ...
    private void initComponents() {
        ...
        setTitle("Practica 18");
        setBackground(new java.awt.Color(255, 255, 255));
        setMinimumSize(new java.awt.Dimension(790, 780));
    ...
    private void addBookButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBookButtonActionPerformed
        Book new_book = assignBookInformation();
        ...
        try{
            if(new_book.isValid()){
                ...
                JOptionPane.showMessageDialog(this, "Información del Libro Inválida", "LIBRO NO VÁLIDO", JOptionPane.WARNING_MESSAGE);
            }   
        } catch (Exception e){
